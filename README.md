...
**DragonVPN v2.3.2** — стабильный подписанный выпуск для Android, рассчитанный на повседневную работу с большими подписками и сложными сетями. Это самостоятельный клиент DragonVPN со своим оформлением, логикой управления профилями, инструментами проверки и встроенными средствами обхода DPI.

### Что улучшено

- **Обновление без потери данных** — официальный APK подписан постоянным ключом проекта и устанавливается поверх `v2.3.1` с сохранением профилей и настроек.
...
1. Скачайте `DragonVPN-v2.3.2-universal.apk` только со страницы [официальных релизов](https://github.com/anonymouskeys/Dragon-vpn/releases/latest).
2. Если у вас установлена официальная версия `v2.3.1`, откройте APK и подтвердите обновление — удалять старое приложение не нужно.
